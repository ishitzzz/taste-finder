...
- Implemented local inference/recommendation engine and starter catalog.
- Added both CLI and a minimal web app experience for collecting taste signals and visualizing results.
- Next immediate priority: persistence + authenticated onboarding.
